...
ImpactRecord.create!([
  ...
  {impact_id: 62, impact_type_id: 6, article_id: 4}
])
ImpactType.create!([
...
User.create!([
  {name: "David Robinson", password_digest: "$2a$10$zDHvVZmLwBkFPWmAMLew7ucMRCZQEmN6YKVgBM.P6ZPCF75hkgX52", bio: "", email: "drobinson@lohud.com", image: nil, first_name: nil, last_name: nil, publication_id: 1, title: "Reporter"}
])
